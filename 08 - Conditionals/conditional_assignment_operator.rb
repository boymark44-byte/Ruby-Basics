...
# Conditional Assignment was written to assign a value to a variable very similar to how the equal sign works but the difference here is it is conditional meaning that Ruby will only assign that value to a variable based on a condition or criteria being met.
