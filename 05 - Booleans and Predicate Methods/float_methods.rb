...
puts 3.14159.round(3) # Returns a rounded-float object with three decimal digits
puts 3.14159.round(4) # Returns a rounded-float object with four decimal digits
